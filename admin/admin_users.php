                      ...
                      <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
                        <table class="w-full mb-6">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="px-4 py-2 border"><?php echo htmlspecialchars($adminUser['name']); ?></td>
                              <td class="px-4 py-2 border"><?php echo htmlspecialchars($adminUser['email']); ?></td>
                              <td class="px-4 py-2 border"><?php echo htmlspecialchars($adminUser['mobile']); ?></td>
                            </tr>
                            <?php endforeach; ?>
                          </tbody>
                        </table>
