...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    if ($customer->transfer($amount, $recipientEmail)) 
    {
    ...
    {
        echo "Transfer failed. Please check the recipient's email and your balance.";
    }
}
            ...
            <dl
              ...
              <div
                ...
                <dd
                  ...
                  BDT <?php echo number_format($customer->getBalance(), 2); ?>
                </dd>
              </div>
            </dl>
