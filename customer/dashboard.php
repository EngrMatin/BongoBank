...
//if (!isset($_SESSION['customer']) || $_SESSION['customer']['type'] !== 'customer') 
...
$transactions = Transaction::getTransactionsByEmail($current_customer['email']);
?>
                    ...
                    <button
                      ...
                      <span
                        ...
                        <span class="font-medium leading-none text-emerald-700">
                            <?php echo htmlspecialchars(getInitials($current_customer['name'])); ?>
                        </span>
                      </span>
                    </button>
                  </div>
              ...
              <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                  <div class="text-base font-medium text-white">
                      <?php echo htmlspecialchars($current_customer['name']); ?>
                  </div>
                  <div class="text-sm font-medium text-emerald-300">
                      <?php echo htmlspecialchars($current_customer['email']); ?>
                  </div>
                </div>
                <button
                  type="button"
        ...
        <header class="py-10">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">
              Welcome to <?php echo htmlspecialchars($current_customer['name']); ?> 👋
            </h1>
          </div>
        </header>
      </div>
            ...
            <dl
              ...
              <div
                ...
                <dd
                  ...
                  BDT <?php echo htmlspecialchars(number_format($customer->getBalance(), 2)); ?>
                </dd>
              </div>
            </dl>
                      ...
                      <?php foreach ($transactions as $transaction): ?>
                        <tr>
                          <td
                            ...
                            <?php echo htmlspecialchars(Customer::getNameByEmail($transaction['email'])); ?>
                          </td>
                          <td
                          ...
                          <td
                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                            <?php echo htmlspecialchars(Customer::getNameByEmail($transaction['recipientEmail'])); ?>
                          </td>
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium text-emerald-600">
                            <?php echo htmlspecialchars($transaction['recipientEmail']); ?>
                          </td>
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium text-emerald-600">
                          ...
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium text-emerald-600">
                            BDT <?php echo htmlspecialchars(number_format($transaction['amount'], 2)); ?>
                          </td>
                          <td
